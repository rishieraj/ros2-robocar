...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'mobile_car.urdf'
    xacro_file = "mobile_car.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "mobile_car"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("mobile_car"), "rviz", "display_default.rviz"]
    )
